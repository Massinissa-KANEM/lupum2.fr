...
<header>
    <div class="container">
        ...
        <div class="logo">
            ...
            <div class="menu">
                <ul>
                <li class="simple_button"><a href="#"><ion-icon name="information-circle-outline"></ion-icon>Infos</a></li>
                <li class="simple_button"><a href="#"><ion-icon name="information-circle-outline"></ion-icon>Planning</a></li>
                <li class="simple_button"><a href="#"><i class="fa-light fa-users-medical"></i>Assister</a></li>
