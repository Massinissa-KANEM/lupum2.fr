...
<head>
    ...
    <link rel="stylesheet" href="https://kit.fontawesome.com/aec9a4d043.css" crossorigin="anonymous">
    <script src="https://kit.fontawesome.com/aec9a4d043.js" crossorigin="anonymous"></script>

    <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
    <script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    <link rel="stylesheet" href="CSSs/index.css">
    <link rel="shortcut icon" href="images/logo_without_text.png" type="image/x-icon">
    <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    <script type="text/javascript">
        function googleTranslateElementInit() {
            new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'fr,es,de,it,zh-CN,ar,hi,pt,ru,ja', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');        }
    </script>
    <title>Lupum2 - Accueil</title>
</head>  
            ...
            <div class="logo">
                ...
                <div class="menu">
                    ...
                    <ul>
                        ...
                        <li class="big_button"><a href="files/connexion.php"><i class="fa-regular fa-user"></i>Connexion</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <main>
        ...
        <div class="first_block">
            ...
            <div class="intro">
                ...
                <a href="files/inscription.php"><div class="inscription"><ion-icon name="log-in-outline"></ion-icon>S'inscrire</div></a>
            </div>
