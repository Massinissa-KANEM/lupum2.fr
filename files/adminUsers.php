      ...
      <div class="card mb-4">
        <div class="card-header pb-0">
          ...
          <div class="input-container">
            ...
            <label for="input" class="label">Rechercher un user :</label>
              ...
              <tbody>
                ...
                while($a < count($valeure)){
                  echo '<tr class="commande">';
                    ...
                    echo '<h6 class="mb-0 text-sm">'. $valeure[$a]['firstName'] . ' ' . $valeure[$a]['lastName'] . '</h6>';
                    echo '</div>';
                    echo '</div>';
                    echo '</td>';
                    echo '<td>';
                    ...
                    // var_dump($valeure[$a]['userStatus']);

                    if($valeure[$a]['userStatus'] == 1){
                      echo '<span class="badge badge-sm bg-gradient-success">Admin</span>';
                    }else if($valeure[$a]['userStatus'] == 0){
                    ...
                    if($valeure[$a]['poste'] == NULL){
                      echo '<h6 class="text-xs font-weight-bold mb-0">NULL</h6>';
                    }else{
                      echo '<h6 class="text-xs font-weight-bold mb-0">' . $valeure[$a]['poste'] . '</h6>';
                    }
                    echo '</span>';
                    echo '</td>';
                    echo '<td class="align-middle text-center">';
                    echo '<span class="text-secondary text-xs font-weight-bold">';
                    if($valeure[$a]['entreprise'] == NULL){
                      echo '<h6 class="text-xs font-weight-bold mb-0">NULL</h6>';
                    }else{
                      echo '<h6 class="text-xs font-weight-bold mb-0">' . $valeure[$a]['entreprise'] . '</h6>';
                    }
                    echo '</span>';
                    echo '</td>';
                    ...
                    echo '<td class="align-middle">';
                        echo '<a href="editUser.php?id=' . $valeure[$a]['id'] . '" class="text-secondary font-weight-bold text-xs"  data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Modifier</a>';
                    echo '</td>';
                  ...
                  if (isset($_POST['update_status'])) {
                    ...
                    // var_dump($user_id);
                    $query = "SELECT userStatus FROM users WHERE id = $user_id";
                    $result = mysqli_query($conn, $query);
                    $row = mysqli_fetch_assoc($result);

                    $current_status = $row['userStatus'];
                    ...
                    $query = "UPDATE users SET userStatus = $new_status WHERE id = $user_id";
