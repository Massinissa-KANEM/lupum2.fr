...
<head>
  ...
  <link href="../CSSs/adminCommandes.css" rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link  active" href="adminCommandes.php">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>office</title>
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Commandes</h6>
      </nav>
    </div>
      ...
      <ul class="navbar-nav  justify-content-end">
        <li class="nav-item d-flex align-items-center">
          <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
            <span class="d-sm-inline d-none"><a href="deconnexion.php" class="logout"><ion-icon name="log-out-outline"></ion-icon></a></span>
          </a>
        </li>
      </ul>
    </div>
        ...
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <div class="input-container">
              ...
              <label for="input" class="label">Rechercher une commande :</label>
              <div class="underline"></div>
            </div>
          </div>
          <div class="card-body px-0 pt-0 pb-2 commandes">
            <?php
              ...
              $sql = "SELECT activite, total,commande_date, email_organisateur, date_debut, date_fin, GROUP_CONCAT(email) AS emails FROM commandes GROUP BY activite, total, commande_date, email_organisateur, date_debut, date_fin ORDER BY commande_date DESC";
...
<script>
  $(document).ready(function(){
    $('#search').on('input', function(){
      ...
      $('.commandes .commande').each(function(){
