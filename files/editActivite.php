...
<body>
    <main>
    <button class="cta">
            <a href="adminActivite.php">Page admin</a>
        ...
        <?php 
            ...
            $q = 'SELECT nom FROM activites WHERE id_activite = '.$id.'';
                        ...
                        <div class="p-3 py-5">
                            ...
                            <?php
                                ...
                                if(isset($_POST['prenom'])){
                                    $nom = $_POST['prenom'];
                                    $q = 'UPDATE activites SET nom = "'.$nom.'" WHERE id_activite = '.$id.'';
                                    $result = mysqli_query($conn, $q);
