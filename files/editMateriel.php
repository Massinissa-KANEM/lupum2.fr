...
<body>
    <main>
        ...
        <?php 
            ...
            $q = 'SELECT nom_materiel, prix FROM materiaux WHERE id_materiel = '.$id.'';
                    ...
                    <div class="col-md-12">
                        <div class="p-3 py-5">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="row mt-2">
                                    <?php
                                        echo'<div class="col-md-6"><input type="text" name="materiel" placeholder="Materiel" value="' . $nom . '"></div>';
                            ...
                            <?php
                                ...
                                if(isset($_POST['materiel'])){
                                    ...
                                    $q = 'UPDATE materiaux SET nom_materiel = "'.$nom.'", prix ="' . $prix .'"  WHERE id_materiel = '.$id.'';
                                    $result = mysqli_query($conn, $q);
